...
rnl::Interface::Interface (ros::NodeHandle& _nh, ros::NodeHandle& _nh_private, std::string _phyMode = "DsssRate1Mbps", 
        ...
        int _num_nodes = 3):
        // ros::NodeHandle& _nh, ros::NodeHandle& _nh_private,
...
void rnl::Interface::setInternet()
{
  ...
  // ns3::NS_LOG_INFO ("Assign IP Addresses.");
...
void rnl::Interface::sendPacket1 (ns3::Ptr<ns3::Socket> soc, uint32_t pktSize,
